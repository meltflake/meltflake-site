...
export const sections: TrackerSection[] = [
  {
    ...
    rows: [
      ...
      { name: '公共 AI 研究投资 (2026-2030)', value: '> S$1B（7.79 亿美元）', source: 'MDDI, 2026.1.24', sourceUrl: 'https://www.mddi.gov.sg/newsroom/singapore-invests-over-s-1-billion-in-national-ai-research-and-development-plan-to-strengthen-ai-research-capabilities-and-our-position-as-global-ai-hub/' },
  ...
  },
  {
    ...
    title: '人才培养',
    rows: [
      { name: 'AI 专业人才目标', value: '2019 年 2,000 → 2023 年 5,000 → 2029 年目标 15,000（外籍占 35%）', source: 'MDDI, 2026.1', sourceUrl: 'https://www.mddi.gov.sg/newsroom/singapore-invests-over-s-1-billion-in-national-ai-research-and-development-plan-to-strengthen-ai-research-capabilities-and-our-position-as-global-ai-hub/' },
  ...
  },
  {
    ...
    title: '国际排名',
    rows: [
      { name: 'Microsoft AI 采用率', value: '全球第 2（60.9%，仅次于 UAE 64.0%）', source: 'Microsoft AI Economy Institute, 2026.1', sourceUrl: 'https://www.microsoft.com/en-us/corporate-responsibility/topics/ai-economy-institute/reports/global-ai-adoption-2025/' },
